...
/** Smooth pixel-coordinate movement for the client-only placement preview. */
@Environment(EnvType.CLIENT)
public final class IngredientPreviewPositionAnimation implements ICustomAnimation {
    public static final long DURATION_MILLIS = 40L;
    ...
    /** Marks the beginning of a new outline render pass. */
    public void beginFrame() {
        visibleLastFrame = visible;
        visible = false;
    }

    /** Updates the target in pixels without allocating a vector per render frame. */
