...
public final class KHBlocks {
    ...
    public static final Block BAMBOO_DISPLAY_TRAY = commonReg("bamboo_display_tray", HodgepodgeDisplayTrayBlock::new, BlockBehaviour.Properties.of().instabreak().ignitedByLava().noOcclusion().sound(SoundType.BAMBOO));
